...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002668373094'))
...
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002609256351'))  # set shortner log channel
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002609256351')
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002609256351')
